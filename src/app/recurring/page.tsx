        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setForm((f) => ({
                    ...f,
                    frequency: e.target.value as FrequencyOption,
                  }))
                }
                className={inputClass}
              >
          ...
          <div>
            ...
            <input
              ...
              value={form.next_due}
              onChange={(e) =>
                setForm((f) => ({ ...f, next_due: e.target.value }))
              }
              className={inputClass}
            />
          </div>
...
function NextOccurrences({ rule }: { rule: RecurringRule }) {
  const getNextOccurrences = () => {
    ...
    let date = new Date(rule.next_due);
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-2 text-xs text-[var(--color-text-muted)]">
                  ...
                  <span>{getFrequencyLabel(rule.frequency, rule.day_of_month)}</span>
                </div>
