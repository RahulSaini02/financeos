...
const CONTACT_EMAIL = "privacy@financeos.app";
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>
                ...
                the AI assistant are processed by Anthropic&apos;s Claude API to generate responses.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>
                ...
                responses. Your chat messages are sent to Anthropic&apos;s API for processing. See{" "}
      ...
      <footer className="border-t border-[var(--color-border)] py-6 mt-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 flex flex-wrap gap-4 justify-between text-sm text-[var(--color-text-muted)]">
          ...
          <div className="flex gap-5">
            <Link href="/privacy" className="text-[var(--color-accent)]">Privacy</Link>
